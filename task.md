...
- [ ] **1.7 Main Console Dashboard UI**
  - [ ] Implement a premium Next.js glassmorphism admin dashboard.
  - [ ] Design visual metrics boards, alert flow lines, interactive node exposure maps, and the update/patch control UI.
